...
<head>
    ...
    <title>Welcome to Paishad Bank</title>
...
<div id="lock"><img src="static/PngItem_5146697.png" alt="" style="width:50%; margin-top:50%;"><br>
...
<div id="container">
    ...
    <div class="container-large"
        style="color:black; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:#fffdd0;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> Parishad
                        Bank!</b></p>
            </div>
